...
class Inklammern_RewritePlus_Block_Adminhtml_Page_Grid_Container_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
	...
	public function getHeaderText()
	{
		...
		{
			return $this->_getHelper()->__("Edit Page (ID: %d)", $model->getId());
		} else
		{
			return $this->_getHelper()->__("New Page");
		}
	}
